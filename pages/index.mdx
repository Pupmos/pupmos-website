...
<div className="lg:flex lg:flex-row mt-5 items-center relative">
  ...
  <div className='object-contain xs:w-full md:w-2/3 relative h-[400px]'>
      <NextImage layout='fill' className="object-contain" src="/animations/govmos-cycle-graphic.png"/>
  </div>
</div>
